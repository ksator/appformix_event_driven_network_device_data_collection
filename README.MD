...
```
sudo -s
git clone https://github.com/ksator/automated_junos_show_commands_collection_with_appformix_python.git
```
...
```
cd appformix_python_event_driven_device_data_collection
